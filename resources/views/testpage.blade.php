...
<form id="shippingAddress" method="psot" action="{{route('universalstatuschange')}}">
<div id="locationList"></div>
<br>
<div class="input-field">
<textarea class="input_fields materialize-textarea" id="address" name="address" type="text"></textarea>
<label class="active" for="address">Address (Area and Street)</label>
</div>
<div class="input-field">
<input class="input_fields" id="locality" type="text" name="locality">
<label class="active" for="locality">Locality</label>
</div>
<div class="input-field">
<input class="input_fields" id="city" type="text" name="city">
<label class="active" for="city">City/District/Town</label>
</div>
<div class="input-field">
<input class="input_fields" id="postal_code" type="text" name="postal_code">
...
<div class="input-field">
<input class="input_fields" id="state" type="text" name="state">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1eemFYHG4tWaDKHmlbhs9J-3FHglW9BI"></script>
...
getGeolocation = (lat, lng) => {
const latlng = lat + "," + lng;
 fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng= '+ latlng +' &sensor=false&key=AIzaSyD1eemFYHG4tWaDKHmlbhs9J-3FHglW9BI')
.then(res => res.json())
