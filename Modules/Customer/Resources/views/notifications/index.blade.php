                            ...
                            <tr>
                              ...
                              <td>
                                <div class="notification-wrap">
                                  <h6>{{ucfirst($notification->title)}}</h6>
                              ...
                              <td>
                                ...
                                @if($data!="")
                                  @if($notification->type=='Order')
                                    <a href="{{route('customer.order.details',$data['id'])}}" class="notification-link">View</a>
                                  @elseif($notification->type=='Booking')
                                    <a href="{{route('customer.Booking.Details',$data['id'])}}" class="notification-link">View</a>
                                  @elseif($notification->type=='Membership')
                                    <a href="{{route('customer.membership.index',$data['id'])}}" class="notification-link">View</a>  
                                  @endif
                                @endif
                              </td>
                            </tr>
