...
<div class="card">
   ...
   <div class="card-body">
     ...
     <div class="form-group row">
            ...
            <label></label>
            @if($updatedata!='')
            <img src="{{asset('images/frontpages/galleryphotos/'.$updatedata->image)}}" class="img-thumbnail" width="80">
            @endif
            </div> 
      </div>
                  ...
                  <table id="dataTable" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr class="notification{{$value->id}}">
                           ...
                           <td>{{$value->heading }}</td>
                           <td><img src="{{asset('images/frontpages/galleryphotos/'.$value->image)}}" class="img-thumbnail" width="80"></td>
                           <td>
