...
<div class="card">
   ...
   <div class="card-body">
     ...
     <div class="form-group row">
         ...
         <textarea class="form-control" autocomplete="random"  id="Content" name="content">{{old('content')}}</textarea>
                  ...
                  <table id="dataTable" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr class="notification{{$value->id}}">
                           ...
                           <td>
                              <span class="Statuschange badge @if($value->status=='0') badge-danger @else badge badge-success @endif" data-id="{{$value->id}}"  data-model="AcademyFacility" id="Statuschange{{$value->id}}">
                              @if($value->status=="0") Deactive @else Active @endif 
                              </span>
                           </td>
                           <td class="action ">
                              <a class="icon-btn delete universaldelete" href="javascript:void(0);" data-status="0" data-id="{{ $value->id}}"  data-model="AcademyFacility" id="notification{{$value->id}}" > <i class="fal fa-trash-alt" id="delete-btn"></i></a> 
                           </td>
                        </tr>
                        @endforeach
                     </tbody>
