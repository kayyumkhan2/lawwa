...
@section('title') Business Times   @endsection
@section('content')
<style type="text/css">
   .btn-secondary{
   pointer-events: none;
...
<div class="main-content">
    <div class="dash__block">
        ...
        <form class="request" method="POST" action="{{route('businesstimes.store')}}">
            {{ csrf_field() }}
                        ...
                        @if ($bTime = $bTimes->where('day', $day)->first())
                            <div class="item">
                                <section class="item__block item__block--no-margin">
                                    ...
                                    <a title="Edit this business time" href="{{route('businesstimes.edit',$bTime->id)}}" class="item__edit"><span class="glyphicon glyphicon-edit" aria-hidden="true">Edit</span></a>
