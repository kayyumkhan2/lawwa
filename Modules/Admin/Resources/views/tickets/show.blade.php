...
<div class="main-content">
	<div class="page-title col-sm-12">
	  <div class="row align-items-center">
	    <div class="col-md-6">
	        <h1 class="h3 m-0">#{{ $ticket->ticket_id }} - {{ $ticket->title }}</h1>
	    </div>
	    <div class="col-md-6">
	...
	<div class="col-sm-12">
	  <div class="row">
	    <div class="col-md-12 text-right"> 
	       <a class="btn btn-sm btn-info rounded-pill " href="{{ route('admin.tickets.index') }}" ><i class="fa fa-ticket" aria-hidden="true"></i> Tickets </a>
	        </div>
		      ...
		      <div class="box bg-white">
		        <div class="box-row">
                  ...
                  <div class="row">
                     ...
                     <div class="col">Priority : {{ $ticket->priority }}</div>
                     <div class="col">
	                  ...
	                  <div class="col-inside-lg decor-default">
                       ...
                       @if($ticket->user!="")
                        <div class="answer-add">
	                           <form action="{{ route('admin.ticket.comment') }}" method="POST" class="form">
	                              {!! csrf_field() !!}
