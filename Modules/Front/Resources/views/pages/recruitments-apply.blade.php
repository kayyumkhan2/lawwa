...
@section('title') Apply @endsection
@section('content')
<!-- Lawwa Page Title -->
{!! NoCaptcha::renderJs() !!}
<section class="lawwa-page-title style-two" style="background-image: url({{ asset('front/assets/images/backgrounds/bg-background.png')}})">
 ...
 <!--    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{route('pages.recruitments')}}">Recruitments</a></li>
          <li class="breadcrumb-item"><i class="fa fa-angle-double-right" aria-hidden="true"></i></li>
          <li class="breadcrumb-item"><a href="javascript:history.go(-1)">Recruitments Details</a></li>
          <li class="breadcrumb-item"><i class="fa fa-angle-double-right" aria-hidden="true"></i></li>
          <li class="breadcrumb-item active-breadcrumb">Apply</a></li>
  ...
  <div class="container">
    <div class="support-info">
      <div class="row">
        <div class="col-md-8">
          <div class="img-block">
            <img src="{{asset('front/assets/images/join-us.png')}}" alt="support">
          </div>
          <form  action="{{route('pages.recruitmentapply.store')}}" method="post" id="formid" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <input type="text" readonly="" class="form-control {{ $errors->has('subject') ? 'error' : '' }}" value="{{old('subject',$Recruitment->heading)}}" id="subject" name="subject" placeholder="Subject">
