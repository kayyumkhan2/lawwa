        ...
        <div class="right-content content">
          <div class="feedback-header">
           ...
           <div class="my-account-header">            
            <form  action="{{route('beautician.feedback.store')}}" method="post" id="formid" enctype="multipart/form-data">
            @csrf
              <div class="feedback-detail show-block" style="">
                ...
                <div class="form-group">
                  <input type="email" readonly="" class="form-control {{ $errors->has('email') ? 'error' : '' }}" value="{{old('email',@Auth::user()->email)}}" id="email" name="email"  placeholder="Email">
                  @if ($errors->has('email'))
                    <div class="error">
                        {{ $errors->first('email') }}
                    </div>
                ...
                <div class="form-group">
                  <input type="tel" readonly="" class="form-control {{ $errors->has('phone') ? 'error' : '' }}"  name="phone" value="{{old('phone',@Auth::user()->phone_no)}}"  placeholder="Mobile No">
                  @if ($errors->has('phone'))
                    <div class="error">
                        {{ $errors->first('phone') }}
                    </div>
