        ...
        <div class="col-lg-9">
            <div class="right-content content">
                  ...
                  <!-- <div class="col-sm-5">
                    <div class="form-group m-0">
                      <select class="form-control" id="exampleFormControlSelect1">
                        <option>My upcoming orders</option>
                        <option>My upcoming orders</option>
                        <option>My upcoming orders</option>
                        <option>My upcoming orders</option>
                        <option>My upcoming orders</option>
              ...
              <div class ="ticket-right-content">
                ...
                <form class="form-horizontal" role="form" method="POST" name="ticket" action="{{ route('beautician.ticket.store') }}">
                    {!! csrf_field() !!}
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                          ...
                          <textarea rows="10" id="message" class="form-control" required="" name="message" placeholder="Message..."></textarea>
